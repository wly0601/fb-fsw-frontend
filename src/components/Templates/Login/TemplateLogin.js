            ...
            <Col>
              ...
              <Form className='text-center'>
                <Form.Group className='my-3 mx-5'>
                  <Form.Text style={{ marginLeft: '50px' }}>Belum punya akun? </Form.Text><Link to='/register' style={{ textDecoration: 'none' }}><Form.Text style={{ color: '#7126B5', fontWeight: 'bold' }}>Daftar di sini</Form.Text></Link>
                </Form.Group>
              </Form>
            </Col>
          </Row>
